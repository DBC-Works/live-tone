...
describe('executionOperation', () => {
  describe('executeCode', () => {
    ...
    it('should call `setPlay` api if code is valid', () => {
      ...
      // act
      executeCode([{ main: true, code: 'LiveTone.start()' }], apiMock)
    ...
    it('should throw an error if code is invalid', () => {
      ...
      // act
      expect(() => {
        executeCode([{ main: true, code: 'invalid code' }], apiMock)
      }).toThrow()
    ...
    it.each([
      ...
      (keyword: string, code: string) => {
        ...
        // act
        expect(() => {
          executeCode([{ main: true, code }], apiMock)
        }).toThrow()
    ...
    it('should throw a ValidationError if code contains many errors', () => {
      ...
      // act
      expect(() => {
        executeCode([{ main: true, code: 'alert();window;' }], apiMock)
      }).toThrow()
